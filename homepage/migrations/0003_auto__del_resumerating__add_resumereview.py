...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ResumeReview'
        db.create_table(u'homepage_resumereview', (
        ...
        db.send_create_signal(u'homepage', ['ResumeReview'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ResumeReview'
        db.delete_table(u'homepage_resumereview')
